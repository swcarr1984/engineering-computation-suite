...
This model solves the 2‑D transient conduction equation with boundary conditions including:
- Natural convection
- Forced jet cooling
- Transient heat generation
- Non‑uniform node spacing

The node layout follows a geometry from a Thermofluids text, forming a structured 36‑node grid.
